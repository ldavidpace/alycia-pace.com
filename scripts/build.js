...
let env = process.argv.find(function(arg) {return arg.includes('--env')})
if (env) {
  env = env.split('=')[1].replace("\"", '')
  console.log('Running as env', env);
}
// Do this as the first thing so that any code reading it knows the right env.
process.env.BABEL_ENV = env || 'production';
...
const deleteFolderRecursive = async function(path, leaveDir) {
